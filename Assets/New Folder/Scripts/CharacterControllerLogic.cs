...
public class CharacterControllerLogic : MonoBehaviour 
{
	...
	private static float cooldown1;
	...
	void Update() 
	{
		cooldown1 = CoolDown.cooldown1;
		cooldown2 = CoolDown.cooldown2;
		...
		if (animator && gamecam.CamState != ThirdPersonCamera.CamStates.FirstPerson)
		{
			...
			{
				Debug.Log ("No Attackkkkkkkkk111111111111");
			}
	...
	{
		if (Input.GetKeyDown (KeyCode.Alpha2)) {
			animator.SetBool ("_isAttack1", true);
			Invoke ("Invoke2", 1f);
		}
	}
	...
	{
		if (Input.GetKeyDown (KeyCode.Alpha3)) {
			animator.SetBool ("_isAttack2", true);
			Invoke ("Invoke3", 1f);
		}
	}
	public void Invoke1()
	...
	public void Invoke2()
	{
		animator.SetBool ("_isAttack1", false);
	}

	public void Invoke3()
	{
		animator.SetBool ("_isAttack2", false);
	}

	IEnumerator skill1_cooldown()
	{
